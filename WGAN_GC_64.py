...
class Generator(torch.nn.Module):
    def __init__(self, channels):
        ...
        # State (cx32x32)
        self.fc = nn.Linear(in_features=32 * 32, out_features=64 * 64)
...
class Discriminator(torch.nn.Module):
    def __init__(self, channels):
        ...
        # Image (Cx64x64)
        self.cv0 = nn.Conv2d(in_channels=channels, out_channels=128, kernel_size=4, stride=2, padding=1)
...
class WGAN_CP(object):
    ...
    def train(self, train_loader):
        ...
        for g_iter in range(self.generator_iters):
            ...
            D_losses.append(d_loss.tolist()[0] / self.critic_iter)
