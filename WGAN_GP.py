...
class Generator(torch.nn.Module):
    def __init__(self, channels):
        ...
        # State (256x16x16)
        self.conv4 = nn.ConvTranspose2d(in_channels=256, out_channels=256, kernel_size=4, stride=2, padding=1),
        self.bn4 =   nn.BatchNorm2d(num_features=256),
        self.relu4 = nn.LeakyReLU(True),
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
        # State (256x32x32)
        self.conv5 = nn.ConvTranspose2d(in_channels=256, out_channels=256, kernel_size=4, stride=2, padding=1),
        self.bn5 =   nn.BatchNorm2d(num_features=256),
        self.relu5 = nn.LeakyReLU(True),
    ...
    def train(self, train_loader):
        ...
        for g_iter in range(self.generator_iters):
            ...
            for d_iter in range(self.critic_iter):
                ...
                images = images.view(self.batch_size, 1, 256, 256)
